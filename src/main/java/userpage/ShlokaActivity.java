...
public class ShlokaActivity {

	WebDriver driver=null;

	public ShlokaActivity(RemoteWebDriver driver15) {
		this.driver=driver15;
	}

	
	
	public void ShlokaValidation() {
		
		
		driver.get("https://cultureseekerz.com/activityWithTeacher?Activity=Shloka&class=Shloka");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			// Validate icon image
			WebElement iconImage = driver.findElement(By.xpath("(//img[@src='https://culture-seekerz.s3.ap-south-1.amazonaws.com/media/Female teacher.png'])[4]"));
			...
			WebElement NameHeading= driver.findElement(By.xpath("(//div[@class='profileAndImg_container ng-tns-c193138732-0'])[4]"));
			String NameText = NameHeading.getText();
			System.out.println("Name Text Content: " + NameText);
			
			// Find the "read more" link
			WebElement readMoreLink = driver.findElement(By.xpath("(//a[normalize-space()='Read more..'])[4]")); // Replace "readMoreLink" with the actual ID of the read more link
			...
			WebElement paragraphElement = driver.findElement(By.xpath("(//p[contains(text(),\"Greetings everyone! I'm Anusha V, and I bring 5 ye\")])[1]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			// Get the text of the expanded paragraph
			WebElement paragraphElement1 = driver.findElement(By.xpath("(//p[contains(text(),\"Greetings everyone! I'm Anusha V, and I bring 5 ye\")])[1]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			WebElement date = driver.findElement(By.xpath("(//div)[198]"));
			date.click();
			...
			WebElement TeacherDetailsButton = driver.findElement(By.xpath("(//button[@type='button'][normalize-space()='Monthly Availability'])[4]"));
			...
			WebElement June11 = driver.findElement(By.xpath("//span[normalize-space()='16']"));
			June11.click();
