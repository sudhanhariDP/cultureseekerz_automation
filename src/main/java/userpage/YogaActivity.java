...
public class YogaActivity {
	
	WebDriver driver=null;
	
	public YogaActivity(RemoteWebDriver driver20) {
		this.driver=driver20;
		
	}
	
	
	public void YogaValidation() {
		
		driver.get("https://cultureseekerz.com/activityWithTeacher?Activity=Yoga&class=Yoga");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			WebElement paragraphElement = driver.findElement(By.xpath("//p[contains(text(),'Diviya')]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			// Get the text of the expanded paragraph
			WebElement paragraphElement1 = driver.findElement(By.xpath("//p[contains(text(),'Diviya')]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			WebElement June11 = driver.findElement(By.xpath("//span[normalize-space()='12']"));
			June11.click();
			...
			WebElement FreeTrialButton = driver.findElement(By.xpath("(//button[@type='button'][normalize-space()='Book a free trial'])[2]"));
