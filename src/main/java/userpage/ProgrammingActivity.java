...
public class ProgrammingActivity {
		...
		public ProgrammingActivity(RemoteWebDriver driver17) {
			this.driver=driver17;
	}
		
		
		
		public void ProgrammingValidation() {
			
			driver.get("https://cultureseekerz.com/activityWithTeacher?Activity=Programming&class=Programming");
	        ...
	        String expectedText = "Programming";
	     ...
	     // Find the ageGroup dropdown element
	        ...
	        // Select "High School" option from dropdown
	        selectClassGroup.selectByValue("Tue");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				WebElement paragraphElement = driver.findElement(By.xpath("//p[contains(text(),'In the realm of programming, I')]")); // Replace "paragraphId" with the actual ID of the paragraph
				...
				// Get the text of the expanded paragraph
				WebElement paragraphElement1 = driver.findElement(By.xpath("//p[contains(text(),'In the realm of programming, I')]")); // Replace "paragraphId" with the actual ID of the paragraph
				...
				WebElement June11 = driver.findElement(By.xpath("//span[normalize-space()='15']"));
				June11.click();
