...
public class BibleActivity {
	
	
	WebDriver driver=null;
	
	
	public BibleActivity(RemoteWebDriver driver13) {
		this.driver=driver13;
	}


	public void BibleValidation() {
		
		driver.get("https://cultureseekerz.com/activityWithTeacher?Activity=Bible&class=Bible");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      //Teacher's details for Preethi A R
		// Validate activity image
		WebElement activityImage = driver.findElement(By.xpath("(//img[@src=\"https://cultureseekerz-image.s3.ap-south-1.amazonaws.com/media/Bible.jpg\"])[1]"));
		...
		// Validate icon image
		WebElement iconImage = driver.findElement(By.xpath("(//img[@src='https://culture-seekerz.s3.ap-south-1.amazonaws.com/media/Female teacher.png'])[1]"));
		...
		//Heading Content for Preethi A R
		...
		// Get the text of the expanded paragraph
			WebElement paragraphElement = driver.findElement(By.xpath("(//p[contains(text(),\"Hi everyone! I'm Preethi AR, and I have 3 years of\")])[1]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			// Get the text of the expanded paragraph
				WebElement paragraphElement1 = driver.findElement(By.xpath("(//p[contains(text(),\"Hi everyone! I'm Preethi AR, and I have 3 years of\")])[1]")); // Replace "paragraphId" with the actual ID of the paragraph
	...
	private void slowScrollDown(WebDriver driver2, JavascriptExecutor js) {
