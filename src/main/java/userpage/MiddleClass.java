...
public class MiddleClass {
	...
	public MiddleClass(RemoteWebDriver driver22) {
		this.driver=driver22;
		
	}
	
	
	public void MiddleClassValidation() {
		
		
		driver.get("https://cultureseekerz.com/trailclass?ageGroup=Middle");
      ...
      //Heading Content for lists of teacher
        ...
        // Scroll down gradually
	      ...
	      //Heading Content for lists of teacher
			...
			WebElement paragraphElement = driver.findElement(By.xpath("//p[contains(text(),'I am Varsha, an enthusiast with a passion for both')]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			// Get the text of the expanded paragraph
			WebElement paragraphElement1 = driver.findElement(By.xpath("//p[contains(text(),'I am Varsha, an enthusiast with a passion for both')]")); // Replace "paragraphId" with the actual ID of the paragraph
