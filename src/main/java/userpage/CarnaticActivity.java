...
public class CarnaticActivity {
	

	WebDriver driver=null;

	public CarnaticActivity(RemoteWebDriver driver14) {
		this.driver=driver14;
	}

	
	public void CarnaticValidation() {
		
		
		driver.get("https://cultureseekerz.com/activityWithTeacher?Activity=Carnatic&class=Carnatic");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      //Teacher's details for Meera Ganapathy Raman
      		...
      		// Get the text of the expanded paragraph
      			WebElement paragraphElement = driver.findElement(By.xpath("//p[contains(text(),'I am Meera Ganapathy Raman, a traveler on the melo')]")); // Replace "paragraphId" with the actual ID of the paragraph
      			...
      			// Get the text of the expanded paragraph
      				WebElement paragraphElement1 = driver.findElement(By.xpath("//p[contains(text(),'I am Meera Ganapathy Raman, a traveler on the melo')]")); // Replace "paragraphId" with the actual ID of the paragraph
      		            ...
      		            if (popupText.contains("To join this class you need to sign in / register")) {
      		             ...
      		             // Measure time for navigation to login page
      		              ...
      		              //Contents like class type, age group and price for Preethi A R
      		    			...
      		    			WebElement June11 = driver.findElement(By.xpath("//span[normalize-space()='14']"));
      		    			June11.click();
