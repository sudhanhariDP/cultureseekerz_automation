...
public class MathsActivity {
	
	WebDriver driver=null;
	
	public MathsActivity(RemoteWebDriver driver18) {
		this.driver=driver18;
	}
	
	
	public void MathsValidation() {
		
		driver.get("https://cultureseekerz.com/activityWithTeacher?Activity=Maths&class=Maths");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			WebElement paragraphElement = driver.findElement(By.xpath("//p[contains(text(),'Hello, esteemed math enthusiasts! I extend a warm ')]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			// Get the text of the expanded paragraph
			WebElement paragraphElement1 = driver.findElement(By.xpath("//p[contains(text(),'Hello, esteemed math enthusiasts! I extend a warm ')]")); // Replace "paragraphId" with the actual ID of the paragraph
