...
public class KGAndElementaryClass {
	
	WebDriver driver=null;
	
	public KGAndElementaryClass(RemoteWebDriver driver21) {
		this.driver=driver21;
	}
	
	
	public void KGAndElementaryValidation() {
		
		driver.get("https://cultureseekerz.com/trailclass?ageGroup=KG%20and%20Elementary");
     ...
     // Verify the image
			...
			WebElement paragraphElement = driver.findElement(By.xpath("(//p[contains(text(),\"Greetings! I'm Gomathi, a passionate explorer of t\")])[1]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			// Get the text of the expanded paragraph
			WebElement paragraphElement1 = driver.findElement(By.xpath("(//p[contains(text(),\"Greetings! I'm Gomathi, a passionate explorer of t\")])[1]")); // Replace "paragraphId" with the actual ID of the paragraph
			...
			// Find the Enroll Button
				...
				WebElement July14 = driver.findElement(By.xpath("//span[normalize-space()='12']"));
				July14.click();
