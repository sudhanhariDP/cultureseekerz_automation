...
public class ChessActivity {
	...
	public ChessActivity(RemoteWebDriver driver16) {
		this.driver=driver16;
	}
	
	
	public void ChessValidation() {
		
		
		driver.get("https://cultureseekerz.com/activityWithTeacher?Activity=Chess&class=Chess");
     ...
     // Find the ageGroup dropdown element
		...
		//Heading Content for lists of teacher
	  	WebElement HeadingElement= driver.findElement(By.xpath("//div[@class='activity_classes_container ng-tns-c193138732-0 ng-star-inserted']"));
		...
		//Heading Content for lists of teacher
	  	WebElement HeadingElement2= driver.findElement(By.xpath("//div[@class='activity_classes_container ng-tns-c193138732-0 ng-star-inserted']"));
		...
		WebElement activityImage = driver.findElement(By.xpath("//img[@alt='Danesh D']"));
...
//		}
		...
		WebElement NameHeading= driver.findElement(By.xpath("(//div[@class='activity_classes_container_card ng-tns-c193138732-0'])[1]"));
		...
		WebElement paragraphElement = driver.findElement(By.xpath("//p[contains(text(),'Hello! My name is Danesh D, and I have 6 years of ')]")); // Replace "paragraphId" with the actual ID of the paragraph
		...
		// Get the text of the expanded paragraph
		WebElement paragraphElement1 = driver.findElement(By.xpath("//p[contains(text(),'Hello! My name is Danesh D, and I have 6 years of ')]")); // Replace "paragraphId" with the actual ID of the paragraph
		...
		WebElement date = driver.findElement(By.xpath("(//div)[42]"));
		date.click();
